...
2.  **Single Source of Truth**: The file system (presence of `.ftl` files) determines availability.
3.  **Compile-Time Safety**: Verifies that `i18n.toml` exists and the assets directory is valid.
