...
pub use managed::{GlobalLocalizerMode, ManagedI18n};

#[cfg(any(feature = "desktop", feature = "mobile", feature = "web"))]
pub use client::{
    DioxusI18n, use_i18n, use_init_i18n, use_init_i18n_with_mode, use_localized, use_provide_i18n,
    use_provide_i18n_with_mode,
};

#[cfg(feature = "desktop")]
pub mod desktop {
    pub use crate::{
        DioxusI18n, DioxusInitError, GlobalLocalizerMode, ManagedI18n, use_i18n, use_init_i18n,
        use_init_i18n_with_mode, use_localized, use_provide_i18n, use_provide_i18n_with_mode,
    };
}
