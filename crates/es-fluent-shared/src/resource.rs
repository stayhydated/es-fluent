...
pub struct FluentCatalogEntry {
    ...
    pub id: crate::fluent::FluentEntryId,
    /// The entry kind.
...
pub fn classify_fluent_entry(
    ...
    crate::fluent::FluentEntryId::try_new(name.to_string())
        .map(|id| Some(FluentCatalogEntry { id, kind }))
}
...
pub struct FallbackCatalog {
    entries: BTreeMap<(FluentDomain, crate::fluent::FluentEntryId), FluentCatalogEntryKind>,
}
