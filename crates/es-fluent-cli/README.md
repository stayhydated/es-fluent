...
`#[derive(EsFluentThis)]` and keeps the corresponding message entries in sync.
...
1. Update `assets_dir/en/{your_crate}.ftl` (and `assets_dir/en/{your_crate}/{namespace}.ftl` for namespaced types).
